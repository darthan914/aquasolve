...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form action="{{ route('backend.news.store') }}" class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST" novalidate="">
					{{ csrf_field() }}
					<div class="item form-group {{ $errors->has('name') ? 'has-error' : ''}}">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input class="form-control col-md-7 col-xs-12" id="name" name="name" placeholder="Name" required="required" type="text" value="{{ old('name') }}">
								@if($errors->has('name'))
								<code>
					...
					<div class="item form-group {{ $errors->has('picture') ? 'has-error' : ''}}">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">
							Picture Suggested Size 600x329
							<span class="required">
								*
							</span>
						</label>
					...
					<div class="item form-group {{ $errors->has('meta_title') ? 'has-error' : ''}}">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input class="form-control col-md-7 col-xs-12" id="meta_title" name="meta_title" placeholder="Meta Title" required="required" type="text" value="{{ old('meta_title') }}">
					...
					<div class="item form-group {{ $errors->has('meta_url') ? 'has-error' : ''}}">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input class="form-control col-md-7 col-xs-12" id="meta_url" name="meta_url" placeholder="Meta URL" required="required" type="text" value="{{ old('meta_url') }}">
					...
					<div class="item form-group {{ $errors->has('meta_keywords') ? 'has-error' : ''}}">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input class="form-control col-md-7 col-xs-12" id="meta_keywords" name="meta_keywords" placeholder="Meta Keyword" required="required" type="text" value="{{ old('meta_keywords') }}">
					...
					<div class="item form-group {{ $errors->has('meta_description') ? 'has-error' : ''}}">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input class="form-control col-md-7 col-xs-12" id="meta_description" name="meta_description" placeholder="Meta Description" required="required" type="text" value="{{ old('meta_description') }}">
